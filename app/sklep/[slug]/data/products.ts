...
const products: ProductWithDetails[] = [
  {
    ...
    burnTime: 40,
    description:
      "Delikatny rytuał na dobry początek dnia. Zapal świecę podczas porannej kawy, planowania dnia albo krótkiej praktyki wdzięczności. Kompozycja cytrusów i białych kwiatów delikatnie pobudza, ale nie przytłacza, dzięki czemu sprawdzi się także w pracy czy domowym biurze.",
  },
  {
    id: "evening-calm",
    ...
    burnTime: 45,
    description:
      "Wieczorny rytuał, który pomaga odciąć się od dnia. Zapal świecę podczas kąpieli, czytania książki albo praktyki jogi nidry. Lawenda i drzewo sandałowe wyciszają układ nerwowy, a wanilia dodaje poczucia bezpieczeństwa i otulenia.",
  },
  {
    id: "winter-magic",
    ...
    scents: ["Pomarańcza", "Goździki", "Świerk"],
    burnTime: 40,
    description:
      "Limitowany zapach, który przywołuje klimat zimowych wieczorów: mandarynki, przyprawy korzenne, świerkowe gałęzie. Idealna do wspólnego kolędowania, rodzinnej kolacji albo spokojnego wieczoru z ulubionym filmem.",
  },
  {
    id: "gift-set",
    ...
    burnTime: 60,
    description:
      "Zestaw trzech mini świec, dzięki którym można przetestować różne rytuały JIVA albo podarować komuś czas tylko dla siebie. Każda świeca wystarcza na kilka dłuższych wieczorów – w zestawie znajduje się karta z propozycją rytuałów.",
  },
];
